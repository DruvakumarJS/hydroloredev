...
{{--                    <a href="{{route('my_tickets')}}"><i class="fa fa-refresh mr-4" aria-hidden="true"></i></a>--}}
                    <a class="btn btn-primary" href="{{route('raise_ticket')}}">Generate Ticket</a>
                </div>
        ...
        <div class="card table-responsive">
            ...
            @if($tickets->count())
                ...
                <label>Showing {{ $tickets->firstItem() }} to {{ $tickets->lastItem() }} of {{$tickets->total()}}
                    results</label>
            ...
            <div class="modal-content">
                ...
                <form method="post" action="{{route('modify_status')}}">
                    ...
                    <div style="margin:20px">
                        ...
                        <input type="radio" id="javascript" name="status" value="0"
                               style="height:30px; width:30px; vertical-align: middle;">
                    ...
                    <div style="margin:20px;float:right;">
                        <button class=" btn-primary rounded-pill " type="submit" name="action" value=" save"> Save
                            Changes
                        </button>

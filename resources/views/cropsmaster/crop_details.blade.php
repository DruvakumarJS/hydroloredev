        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              ...
              <h5 class="modal-title text-white" id="exampleModalLabel">Edit Crop</h5>
               ...
               <label for="message-text" class="col-form-label label-bold ">Nutrition & Spray</label>
                 ...
                 <div class="row">
                    <div class="col-md-4">
                          ...
                          <input class="form-control" type="text" name="pruning" placeholder="nth day after plantation" value="{{$data->pruning}}" required>   
                    </div>

                    <div class="col-md-4">
                     <label>Staking (Day after planting)*</label>
                          <input class="form-control" type="text"  name="staking" placeholder="nth day after plantation" value="{{$data->staking}}" required>

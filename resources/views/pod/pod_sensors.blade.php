...
<div class="container-body">
    ...
    <div class="row justify-content-center">
       <div class="container-header">
            ...
            <h2 class="head-h1">{{$id}}</h2>
            <label class="date"> {{date('d M ,Y')}} </label>
           
           
            <div id="div2" style="margin-right: 30px">
              <a href="{{route('pod_history',$id)}}"><button class="btn btn-sm btn-outline-primary">View History</button></a>

               <a href="{{route('pods')}}"><button class="btn btn-sm btn-outline-primary">View PODs</button></a>
